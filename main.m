...
%Parameters
segmentSize = 5000;            %This should come from the parameters.
Channel = 1;                    %This should come from the parameters.
a0 = 0.8;                       %Gain of first eco.
t0 = 290;                      %Delay of first eco.
a1 = 0.7;                       %Gain of second eco.
t1 = 350;                      %Gain of second eco.
